module.exports.uiConfig = ($logProvider, $httpProvider,$uibTooltipProvider, RestangularProvider, AuthProvider, hotkeysProvider, favicoProvider)->
  'ngInject'
...
module.exports.uiRun = ($rootScope, Menu, CourseMaterials, favico)->
  'ngInject'
