...
ActiveRecord::Schema.define(version: 20161201112029) do
  ...
  create_table "activities", force: :cascade do |t|
    t.integer  "user_id",       :foreign_key=>{:references=>"users", :name=>"fk_activities_user_id", :on_update=>:no_action, :on_delete=>:no_action}
    t.integer  "season_id",     :foreign_key=>{:references=>"seasons", :name=>"fk_activities_season_id", :on_update=>:no_action, :on_delete=>:no_action}
  ...
  create_table "assignments", force: :cascade do |t|
    t.integer  "user_id",       :null=>false, :foreign_key=>{:references=>"users", :name=>"fk_assignments_user_id", :on_update=>:no_action, :on_delete=>:no_action}
    t.integer  "season_id",     :null=>false, :foreign_key=>{:references=>"seasons", :name=>"fk_assignments_season_id", :on_update=>:no_action, :on_delete=>:no_action}
    t.string   "resource_type"
    t.integer  "resource_id"
  ...
  create_table "jquest_pg_mandatures", force: :cascade do |t|
    t.integer  "legislature_id",    :foreign_key=>{:references=>"jquest_pg_legislatures", :name=>"fk_jquest_pg_mandatures_legislature_id", :on_update=>:no_action, :on_delete=>:no_action}
    t.integer  "person_id",         :foreign_key=>{:references=>"jquest_pg_people", :name=>"fk_jquest_pg_mandatures_person_id", :on_update=>:no_action, :on_delete=>:no_action}
  ...
  create_table "points", force: :cascade do |t|
    t.integer "user_id",           :foreign_key=>{:references=>"users", :name=>"fk_points_user_id", :on_update=>:no_action, :on_delete=>:no_action}
    t.integer "season_id",         :foreign_key=>{:references=>"seasons", :name=>"fk_points_season_id", :on_update=>:no_action, :on_delete=>:no_action}
